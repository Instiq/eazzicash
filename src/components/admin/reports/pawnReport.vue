    ...
    <div class="container ">
      <div class="row  p-1 mb-5" style="margin-top:-30px">
        <div class="col">
          ...
          <div class="row mt-5">
            <div class="col-md-3">
              <p  class="text-success h6 font-weight-bold">Pawn Requests</p>
            </div>
          ...
          <div class="table-responsive" ref="html" id="html" >
              <span v-if="fromDate && toDate" class="font-weight-bold"> Pawn Report from {{customFormatter(fromDate)}} to {{customFormatter(toDate)}}</span>
              <table class="table table-striped table-bordered mt-3">
                  ...
                  <tbody v-if="downloadPawnRequests"   >
                    <tr v-for="(item, index) in downloadPawnRequests" :key="'a' + index">
...
export default {
 ...
 methods : {
   ...
   // change first letter of search input to uppercase
    ...
    exportTableToExcel (tableID, filename = 'Pawn report'){
    let downloadLink;
 ...
 exportToWord(element, filename = 'Pawn report'){
    ...
    //filter data by date
     ...
     if (this.fromDate=="" || this.toDate=="") return this.$store.state.userEntitiesAll.pawn;
     ...
     let data =  this.$store.state.userEntitiesAll.pawn;
