    ...
    <div class="container ">
      <div class="row  p-1 mb-5" style="margin-top:-30px">
        <div class="col">
          ...
          <div class="row mt-5">
            <div class="col-md-3">
              <p  class="text-success h6 font-weight-bold">Investment Requests</p>
            </div>
          ...
          <div class="table-responsive" ref="html" id="html" >
              <span v-if="fromDate && toDate" class="font-weight-bold"> Investment Report from {{customFormatter(fromDate)}} to {{customFormatter(toDate)}}</span>
              <table class="table table-striped table-bordered mt-3">
                  ...
                  <tbody v-if="downloadInvestmentRequests"   >
                    <tr v-for="(item, index) in downloadInvestmentRequests" :key="'a' + index">
...
//     }, 
   ...
   // change first letter of search input to uppercase
    ...
    exportTableToExcel (tableID, filename = 'investment report'){
    let downloadLink;
 ...
 exportToWord(element, filename = 'investment report'){
    ...
    //filter data by date
     ...
     if (this.fromDate=="" || this.toDate=="") return this.$store.state.userEntitiesAll.investment;
     ...
     let data =  this.$store.state.userEntitiesAll.investment;
