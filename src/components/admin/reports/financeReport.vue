    ...
    <div class="container ">
      <div class="row" style="margin-top:-30px">
        <div class="col">
          ...
          <div class="row mt-5">
            <div class="col-md-3">
              <p  class="text-success h6 font-weight-bold">Finance Requests</p>
            </div>
          ...
          <div class="table-responsive" ref="html" id="html" >
              <span v-if="fromDate && toDate" class="font-weight-bold"> Finance Report from {{customFormatter(fromDate)}} to {{customFormatter(toDate)}}</span>
              <table class="table table-striped table-bordered mt-3">
                  ...
                  <tbody v-if="downloadFinanceRequests"   >
                    <tr v-for="(item, index) in downloadFinanceRequests" :key="'a' + index">
...
export default {
 ...
 methods : {
   ...
   // change first letter of search input to uppercase
    ...
    exportTableToExcel (tableID, filename = 'finance report'){
    let downloadLink;
 ...
 exportToWord(element, filename = 'finance report'){
    ...
    //filter data by date
     ...
     if (this.fromDate=="" || this.toDate=="") return this.$store.state.userEntitiesAll.finance;
     ...
     let data =  this.$store.state.userEntitiesAll.finance;
