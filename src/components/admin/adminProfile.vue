        ...
        <section id="mySidenav" class="sidenav" style="z-index:2">
          ...
          <!-- avatar image -->
           ...
           <!-- closenav icon -->
            ...
            <router-link to="/adminProfile/reports"> <img src="./adminIcons/Investments.svg" height="14vh" style="" alt=""> <span class="sidenav-items" style="margin-left:9px">Reports</span></router-link>
