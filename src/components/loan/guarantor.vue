                 ...
                 <section class="section-2"> 
                    ...
                    <div class="form-row one mt-3">
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text"  v-model="phone1" name="phone1" class="form-control" v-validate="'numeric|min:11|max:11|'"   placeholder="" >
                                 <div class="mt-3" >
                    ...
                    <div class="form-row three">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <textarea type="text" v-model="address2" name="address1" class="form-control textarea" v-validate="'max:50'" placeholder="" rows="3"></textarea>
                                  <div class="mt-3" >
