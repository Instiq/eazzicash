  ...
  <div>
        <div class="main-containe">
            <ValidationObserver v-slot="{ passes }">
                <form  @submit.prevent="passes(getInputs)" > 
                    <span class="h5 mb-5 d-block ">{{message}}</span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <ValidationProvider name="title" rules="required" v-slot="{ errors }">
                                        ...
                                        <select :disabled="true" class="browser-default custom-select" v-model="title" name="title">
                                ...
                                <div class=" mb-3">
                                    <ValidationProvider name="firstname" rules="required|max:50" v-slot="{ errors }">
                                        ...
                                        <input type="text" :disabled="true"  v-model="firstname" class="form-control" name="firstname"  placeholder="" require>
                                        <span style="font-size:13px; color:red"> <span v-if="errors[0]"><i class="fas fa-ban"></i></span> {{ errors[0] }}</span>
                                    </ValidationProvider> 
                                </div> 
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" :disabled="true"   v-model="lastname" class="form-control" name="lastname" placeholder="">
                                        <span style="font-size:13px; color:red"> <span v-if="errors[0]"><i class="fas fa-ban"></i></span> {{ errors[0] }}</span>
                                    </ValidationProvider> 
                                    </div> 
                                    <div class="mb-3">
                                    <ValidationProvider name="email" rules="required|email" v-slot="{ errors }">
                                        ...
                                        <div class="input-group">
                                            <input type="text" :disabled="true"  v-model="email" class="form-control"  placeholder=""   name='email'>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <!-- <button class="btn btn-success" :disabled="isCheckedd" @click="approveGuarantor">confirm</button> -->
                        <p class="text-center"> <button class="btn btn-success" :disabled="isCheckedd" type="submit" ><span class="h6">Confirm Approval <span v-if="isLoading"> <i class="fa fa-spinner fa-spin fa-1x fa-fw"></i> </span></span></button></p>
                </form>   
                </ValidationObserver>    
            </div> 
        </div>
...
import reviewLoan from './reviewLoanDetails.vue'
...
export default {
   ...
   //this props isn't mandatory at all, it's just here for fun. If you remove it, make sure to pass the data directly to the template above. the direct parent is the aproveLoan component in this same folder
    props : {
        message : String,
        isLoading:Boolean,
    },
    ...
    methods: {
        ...
        showToastrError () {
         ...
         // This getInputs method is used to pass data from this (child) component to its parent component, data can also be passed inline, by directly using $emit('handler', dataBeingPassed)
       //databeingPassed can be a string, object, array or a variable, in this case, it is an object, with values from the child's local data.
        getInputs () {
            this.$emit('guarantorInputs', {
                title:this.title,
    ...
    computed : {
        ...
        title : {
            get () {
                return this.guarantorsDetails.guarantors[0].title
            },
            // set (value) {
        ...
        firstname : {
            get () {
                return this.guarantorsDetails.guarantors[0].firstName
            },
            // set (value) {
        ...
        email : {
            get () {
                return this.guarantorsDetails.guarantors[0].email
            },
            // set (value) {
        ...
        lastname : {
            get () {
                return this.guarantorsDetails.guarantors[0].lastName
            },
            // set (value) {
            //     value =  value.charAt(0).toUpperCase() + value.slice(1);
